...
if __name__ == '__main__':
    ...
    if args.file_name is None:
        ...
        df_count_bonds = sdats.count_bonds(bond_type=args.bond_type,   cut_off=args.cut_off,
                                                 condition=condition)
