...
if __name__ == '__main__':
    ...
    if args.file_name is None:
        ...
        df_count_atom_types = sdats.count_atom_types(
                                                 condition=condition)
        ...
        dict_count_atom_types = sdat.count_atom_types(condition=condition)
        print(f'condition: {args.x_min} <= x <= {args.x_max}')
        print(f'condition: {args.y_min} <= y <= {args.y_max}')
        print(f'condition: {args.z_min} <= z <= {args.z_max}')
        pprint(dict_count_atom_types)
