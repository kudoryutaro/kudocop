...
class ExportXyz():
    ...
    def export_file(self, sdat, ofn: str, out_columns=None, structure_name=None) -> None:
        ...
        # header_line
        header_line = []
        header_line.append(str(sdat.get_total_atoms()) + '\n')
        header_line.append(structure_name + '\n')

        with open(ofn, 'w') as ofp:
            ofp.writelines(header_line)
        sdat.atoms.to_csv(ofn, columns=out_columns, sep='\t',
